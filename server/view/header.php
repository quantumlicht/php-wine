...
<div class='row-fluid'>
   ...
   <div class='navbar navbar-inverse'>
      <div class='navbar-inner'>
         ...
         <ul class='nav'>
            <li class='active'><a href="http://philippeguay.com/server/qlicht.php">Menu Principal</a></li>
         <?php if(isset($_SESSION['username'])){ ?>    
           <li><a href="http://philippeguay.com/server/forum.php">Forum</a></li>
         <?php }?>
           <li><a href="http://philippeguay.com/server/indexvins.php">Index des vins</a></li> 
            <?php if(!isset($_SESSION['username'])){ ?>    
            <li><a href="http://philippeguay.com/server/controller/qlicht/subscribe.php">Formulaire d'inscription</a></li>
         <?php } ?>
         <li><a href="http://philippeguay.com/server/controller/mail/mailto.php">Contact</a></li>
